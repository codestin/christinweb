...
Published [Virtual Meditation Retreats: Maintaining Mindfulness in Daily Life](https://christinchong.com/virtual-meditation-retreats-maintaining-mindfulness-in-daily-life) - This was my last Write of Passage assignment and I was **dragging my feet on it. **So I implemented a new system where I write my second draft directly in Notion, which **forces me to publish** since my Notion notebook is directly mirrored onto my website using [Super](https://super.so).

- 

Shared **live notes** of the various Zooms I have attended on [Maven](https://christinchong.com/maven-webinar-2021-10-19), [Twitter Game](https://christinchong.com/just-twitter-azul-meeting), [Newsletter Game](https://christinchong.com/just-newsletters-azul-meeting-2021-10-18), and creating [Email-Based Courses (EBCs.)](https://twitter.com/Christintweets/status/1452049399266234368) I realized that this is a professional skill I have that others can find value in, and as you can see with the EBC link, provides me with lots of Twitter fodder! I forget that I have learned to type up notes **REAL FAST on complex topics**, from summarizing a lot of pharmaceutical advisory boards on the fly for my day job.

- 

Like many Write of Passage students, I’m now interested in creating my own cohort-based course (CBC), code-named “**Buddhism for Smart People.**” So I’m looking forward to enrolling in [Maven’s accelerator program](https://maven.com/maven/course-accelerator). In the meantime, I learned that email-based courses (EBCs) are a good way to test ideas and find target audiences. So I’m whipping up a prototype code-named “**[Ask Buddha.](https://ask-buddha.webflow.io/)**” It’s my first time building with Webflow, and I’ve decided to use it because it provides the most slick templates out of all the other landing page builders I’ve investigated. (Message me if you want me to talk through the process of shopping for the right tool!) 
...
[[website](https://christinchong.com)] [[twitter](https://twitter.com/christintweets)]