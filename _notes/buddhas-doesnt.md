...
- While I'm glad that there's more scientific interest in understanding the benefits, **the hypotheses are *****sometimes***** "*****a priori*****"**-i.e. if one is searching for an effect, one is bound to find one. So while these data are interesting to learn about, I don't think they are reasons to practice.
...
When I first heard this story from [Gil Fronsdal](https://www.insightmeditationcenter.org/books-articles/being-ones-own-teacher/), I remember thinking, "no logic, intuition, or reasoning?! Those are my *favorite* mental models for decision-making!"
...
3. Which part (if any) of this article POPs?
4. How can I simplify/streamline the article more? I feel it is a bit too complex in structure (but maybe I'm wrong about that!)
5. Is it worth trying to write/work through this article, even though I feel it turned out quite unexpectedly difficult? The whole point of WOP is to learn to "push through" right? 🤔
