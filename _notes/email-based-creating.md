...
- **EBCs are a good alternative to CBCs, MOOCs**
    ...
    - EBCs are also a lot of work though...Will's tombstone will read "he opened 1 million browser tabs so someone can read 1 email"
...
- **Business models/monetization**
    ...
    - Moving from B2C → B2B
        - One size fit all product → different skews originally, but ended up going straight to B2B
            - DO NOT build a business around a $5 product
...
- **Will's writing rituals**
    - Cyclical, content + selling + operations, typical founder stuff
    - Writes best early in the morning
    - Solving problems in subconscious
    - Divergent → convergent thinking/outlining process (open research → 3 key takeaways)
