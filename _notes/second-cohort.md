...
- Creative output system, not a storage system
...
- When there is a problem, look upstream or downstream. E.g. it might seem like Capture is the problem, but it's actually Organize (downstream) that is the problem

## 2021-11-10 Live Session 2

- Important think about limiting the kinds of content we want to capture
- Information diet is like a real diet. Don't need to eat everything.
- Projects have to be "in motion," it's happening, it's happening! No zombie projects allowed. Remain sensitive and connected to every project item.
- Brainstorm about my project list (might be moved to areas)
    - Life admin: sort out passport issue
    - Sort out financial items
        - Clean up crypto
    - Compassion Accelerator
    - Honeyritual
    - Write of passage:
        - Set up writing system with distribution goals
        - BASB
...
- Projects: portion of your life you will never get back
- Example timeline for publishing a book, the traditional way
- Critical chain theory of constraints says do things as LATE as possible, rather than as early as possible, because it's more effective that way

## (Missed Live Session 3)

## Live Session 4 2021-12-01
...
- [Subscribe to my newsletter](https://christin.substack.com/)
- [Follow and DM me on Twitter](https://twitter.com/christintweets)
- [Schedule a chat](https://calendly.com/christinchong)
- [Sign up for the Compassion Accelerator community](https://compassionaccelerator.com/)
